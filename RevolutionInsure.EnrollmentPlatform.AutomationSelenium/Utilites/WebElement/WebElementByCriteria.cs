...
namespace RevolutionInsure.EnrollmentPlatform.AutomationSelenium.Utilites.WebElement
{
    ...
    public partial class WebElement
    {
        ...
        public WebElement ByNameDataByName(string name, bool exactMatch = true)
        {
        ...
        public WebElement ByNameData(string nameData, bool exactMatch = true)
        {
            return ByAttribute(TagAttributes.NameData, nameData, exactMatch);
        }
